/* Adapted from http://bl.ocks.org/ducky427/5583054
   and https://github.com/vlandham/gates_bubbles */
...
var custom_bubble_chart = (function(d3, CustomTooltip) {
    ...
    //var fill_color = d3.scale.ordinal() //usage fill_color(d.group)
    ...
    function custom_chart(data) {
        ...
        data.forEach(function(d){ //variabile used here
            var node = {
                id: d.id,
        ...
        circles.enter().append("circle")
            ...
            .attr("stroke-width", 2)
            .attr("stroke", function(d) {return d3.rgb(fill_color).darker();})
    ...
    function hide_details(data, i, element) {
        d3.select(element).attr("stroke", function(d) { return d3.rgb(fill_color).darker();} );
        tooltip.hideTooltip();
    }
